...
export default function Library() {
  ...
  const allBooks = useMemo(() => [...published, ...savedBooks], [published, savedBooks])
      ...
      <Layout>
        <div className="pt-16 px-4 pb-32 space-y-6 max-w-2xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] text-zinc-700 uppercase tracking-widest font-sans">Buscando</p>
              <h1 className="text-base text-white font-semibold font-sans">"{searchQuery}"</h1>
            </div>
          </div>
          {searchResults.length === 0 ? (
            <div className="py-20 text-center space-y-2">
              <p className="text-zinc-600 text-sm font-sans">No se encontraron historias.</p>
            </div>
          ) : (
            <>
              <p className="text-zinc-700 text-xs font-sans">{searchResults.length} resultado{searchResults.length !== 1 ? "s" : ""}</p>
        ...
        <div className="mt-14 sm:mt-16 px-4 sm:px-6 flex items-end justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:block">Nueva historia</span>
