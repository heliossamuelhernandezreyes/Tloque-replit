...
import { ArrowLeft, Droplets, Sparkles, BookOpen, Lock, Loader2, ChevronDown, FileText } from "lucide-react"
          ...
          {phase === "revealed" && result && (
            <motion.div key="revealed"
              ...
              <motion.div
                ...
                <button onClick={() => setLocation(`/read/${result.book.id}`)}
              ...
              {result.isDuplicate && (
                <motion.div
                  ...
                  {t("gachaDuplicate").replace("{n}", String(result.paperGranted))}
                </motion.div>
              )}
