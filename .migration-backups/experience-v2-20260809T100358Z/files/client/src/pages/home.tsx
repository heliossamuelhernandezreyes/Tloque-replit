...
import { Loader2, X, Edit3, Trash2, BookOpen } from "lucide-react"
...
function getOpeningLine(book: Book): string {
  const text = book.chapters?.[0]?.content || book.content || ""
  if (!text) return ""
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      >
                        {spotlightBook.isClassic
                          ? `Clásico · ${spotlightBook.publicationYear || t("publicDomain")}`
                          : "Descubrimiento"
                        }
                      </span>
                      {/* badge de género */}
