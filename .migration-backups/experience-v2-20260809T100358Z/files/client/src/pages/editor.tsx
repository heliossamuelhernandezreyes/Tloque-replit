...
import {
  ...
  Check, AlertCircle, Layers, Image, Music2, X,
} from "lucide-react"
...
export default function Editor() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-300 overflow-x-hidden">
      ...
      {/* ── LAYOUT PRINCIPAL ── */}
      <div className="pt-14 flex flex-col md:flex-row md:gap-0 max-w-6xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <textarea
                ...
                className="flex-1 bg-transparent text-zinc-300 outline-none resize-none font-serif leading-[2]"
                style={{ fontSize: "16px", minHeight: "60vh", caretColor: gc.color }}
                onFocus={e => {
