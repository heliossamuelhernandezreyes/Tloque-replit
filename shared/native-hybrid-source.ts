...
export const NATIVE_HYBRID_SOURCES: readonly NativeHybridSource[] = [
  ...
  { kind: "hybrid", instrumentId: "woodwinds.flute", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 60, midiMax: 96, wet: 0.085, notes: "Sample dominante; aire/columna física aporta breath y continuidad dinámica." },
  { kind: "hybrid", instrumentId: "woodwinds.piccolo", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 67, midiMax: 108, wet: 0.065, notes: "Sustain sampleado dominante; overlay de aire muy ligero. Staccato permanece sample-only." },
  { kind: "hybrid", instrumentId: "woodwinds.clarinet", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 50, midiMax: 94, wet: 0.09, notes: "Refuerzo de columna y reed suave bajo el sample." },
  { kind: "hybrid", instrumentId: "woodwinds.bass-clarinet", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 37, midiMax: 70, wet: 0.1, notes: "Iowa real dominante; resonancia continua y presión física ligera." },
  { kind: "hybrid", instrumentId: "woodwinds.oboe", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 58, midiMax: 91, wet: 0.085, notes: "Sample domina la doble lengüeta; overlay sólo estabiliza continuidad." },
  { kind: "hybrid", instrumentId: "woodwinds.bassoon", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 34, midiMax: 75, wet: 0.1, notes: "Sample dominante + bore continuo ligero." },

  { kind: "hybrid", instrumentId: "brass.trumpet", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 54, midiMax: 82, wet: 0.075, notes: "Sample conserva labios/ataque; columna añade continuidad de presión." },
  { kind: "hybrid", instrumentId: "brass.horn", engineVersion: "air-column-overlay-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "air-column-resonator", midiMin: 41, midiMax: 77, wet: 0.09, notes: "Overlay cálido y poco brillante para sostén de columna." },
  ...
  { kind: "hybrid", instrumentId: "piano.grand", engineVersion: "sympathetic-resonance-v1", approval: "studio", masterApproved: false, baseSource: "sample-pack", physicalLayer: "sympathetic-resonance", midiMin: 21, midiMax: 108, wet: 0.08, notes: "Ataque y dinámica quedan sampleados; overlay añade tabla armónica, resonancia simpática y cola física. Pedal down/up de TloqueScore alimenta damper y coupling; controles físicos dedicados llegarán en 2.2." },
