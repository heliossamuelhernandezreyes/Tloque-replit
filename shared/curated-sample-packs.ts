...
function vscoPack(input: Omit<CuratedSamplePackSource, "libraryName" | "version" | "license" | "repositoryUrl" | "pinnedCommit" | "acknowledgement">): CuratedSamplePackSource {
  return {
    ...input,
    ...
    acknowledgement: `VSCO 2 Community Edition se distribuye bajo CC0-1.0. Tloque instalará únicamente ${input.displayName} desde el commit ${VSCO_COMMIT}, verificará cada WAV y lo copiará a App Storage antes de reproducirlo.`,
  }
}
