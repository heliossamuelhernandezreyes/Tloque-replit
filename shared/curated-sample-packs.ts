...
const VSCO_PACKS: readonly CuratedSamplePackSource[] = [
  ...
  vscoPack({ id: "vsco2-ce-piccolo", displayName: "Piccolo · Sustain + Staccato", instrumentId: "woodwinds.piccolo", moduleId: "vsco2-ce-piccolo", manifestId: "vsco2-ce-piccolo", sfzPath: "PiccoloSus.sfz", sfzPaths: ["PiccoloSus.sfz", "PiccoloStac.sfz"], estimatedMegabytes: 12, tags: ["native-samples", "solo", "piccolo", "woodwinds", "cc0", "multi-sfz", "dedicated-articulation"] }),
