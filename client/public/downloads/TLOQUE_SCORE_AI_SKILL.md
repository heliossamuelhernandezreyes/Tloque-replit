...
## Cómo aprovechar la síntesis orquestal V5
...
## Cómo aprovechar Orchestra Conductor V7
...
- escribe en la misma posición los ataques que deban sentirse como un solo gesto; V7 conservará ese grupo aunque `humanize` separe sus microtiempos;
...
- no dupliques tracks para crear “humanización”: V7 ya separa de forma determinista a los miembros de una sección compatible.

V7 no compone ni corrige armonía por su cuenta. Tampoco cambia pitches, duraciones, articulaciones o timbres escritos. Su tarea es coordinar balance, memoria de energía, cohesión de ataques, salidas, color y separación interna de sección dentro de límites seguros. Calcula un silencio desde el final de la última nota que seguía sonando, no desde su ataque; aun así, escribe `rest` cuando la pausa sea una decisión musical explícita.
