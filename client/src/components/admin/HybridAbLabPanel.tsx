...
import { Download, FlaskConical, Loader2, Pause, Play, ShieldCheck, Sparkles } from "lucide-react"
...
export function HybridAbLabPanel() {
  ...
  return <section className="mt-10">
    ...
    <div className="mt-4 grid gap-3 md:grid-cols-2">{hybrids.map(source => {
      ...
      const busy = running === source.instrumentId, candidateBusy = running === `${source.instrumentId}:candidate`, approved = hybridSourceMasterApproved(source), candidateState = candidateStates[source.instrumentId]
