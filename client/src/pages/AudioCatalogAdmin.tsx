        ...
        {tab === "composer" && (
          <section className="rounded-2xl border border-amber-400/20 bg-amber-400/[0.035] p-4 space-y-4">
            ...
            <fieldset className="rounded-xl border border-sky-300/20 bg-sky-300/5 p-3">
              ...
              <p className="mt-2 text-[11px] leading-5 text-zinc-400">Síntesis orquestal funciona sin descargas. Grabaciones + cuerpo físico necesita los bancos: la grabación conserva identidad y articulaciones reales; V5 añade fraseo determinista y cuerpo compatible sin inventar true legato. Ninguna opción se presenta como grabación acústica certificada sin validación. Cambiar la fuente conserva las notas: vuelve a compilar para escuchar.</p>
            </fieldset>
